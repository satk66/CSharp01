...
namespace UsingControl2
{
    public partial class MainForm : Form
    {
        ...
        private void chkBold_Checked(object sender, EventArgs e)
        {
            ChangeFont();
        }
        ...
        private void bthModl_Clik(object sender, EventArgs e)
        {
            Form frm = new Form();
            frm.Text = "Modal Form";
            frm.Width = 300;
        ...
        private void bthMsgBox_Click(object sender, EventArgs e)
        {
        ...
        private void bthAddRoot_Click(object sender,EventArgs e)
        {
            tvDummy.Nodes.Add(random.Next().ToString());
            TreeToList();
        }

        private void bthAddChild_Click(object sender, EventArgs e)
        {
